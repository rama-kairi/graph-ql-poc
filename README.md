# NestJS POC with TypeORM, GraphQL and PostgreSQL
...
Before you start, make sure you have a recent version of [NodeJS](http://nodejs.org/) environment _>=14.0_ with PNPM 6 or Yarn.
